...
// @Success 200 {object} gin.H model.PaymentList
// @Failure 400 {object} gin.H "Invalid offset or limit"
...
func (ph *PaymentHandler) GetAllPayments(c *gin.Context) {
    ...
    payments, total, err := ph.PaymentService.GetAllPayments(params, offset, limit)
    if err != nil {
